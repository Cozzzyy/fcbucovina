...
export function GameCard({ game }: { game: Game }) {
    return (
        <div className="flex flex-col justify-center items-center rounded-md w-full px-2">
            ...
            <div className="flex flex-wrap justify-center items-center w-full gap-5 lg:gap-8 text-center">
                {/* Home Team */}
                ...
                <div className="flex flex-col justify-center items-center px-4">
                    <h3 className="text-xl lg:text-3xl font-semibold select-none pointer-events-none">
                        {game.score}
                    </h3>
                </div>
