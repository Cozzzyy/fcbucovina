        ...
        <div className="flex flex-col justify-center items-center rounded-md">
            ...
            <div className="flex flex-row w-full justify-center items-center">
                <div className="flex flex-row w-full justify-end items-center gap-2">
                    <h3 className="text-[13px] ml-2 text-right font-light no-click">{game.homeTeam}</h3>
                    <img className="w-10 h-auto" src={game.homeTeamLogo} alt={game.homeTeam} />
                </div>
                <div className="flex flex-col w-full justify-center items-center">
                    <h3 className="text-xl font-semibold no-click">{game.score}</h3>
                </div>
                <div className="flex flex-row w-full justify-start items-center gap-2">
                    <img className="w-10 h-auto" src={game.awayTeamLogo} alt={game.awayTeam} />
                    <h3 className="text-[13px] mr-2 font-light no-click">{game.awayTeam}</h3>
                </div>
            </div>
            <h3 className="text-sm font-light opacity-50 mt-4 no-click">{`${game.date} - ${game.location}`}</h3>
